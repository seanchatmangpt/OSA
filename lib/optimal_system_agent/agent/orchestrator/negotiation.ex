defmodule OptimalSystemAgent.Agent.Orchestrator.Negotiation do
  @moduledoc """
  ...
  ## Usage
      ...
      {:ok, result} = OptimalSystemAgent.Agent.Orchestrator.Negotiation.execute_pact("Build a REST API", opts)
  ...
  alias OptimalSystemAgent.Agent.Orchestrator.{Mailbox, SwarmWorker}
