...
func (m Model) openPalette() (Model, tea.Cmd) {
	...
	localCmds := []dialog.PaletteItem{
		...
		{Name: "/theme", Description: "List or switch themes", Category: "config"},
		{Name: "/models", Description: "Browse & switch models", Category: "config"},
		{Name: "/model", Description: "Show or switch current model", Category: "config"},
		...
		{Name: "/swarm", Description: "Launch a multi-agent swarm", Category: "agents"},
		{Name: "/swarms", Description: "List active swarms", Category: "agents"},
		{Name: "/swarm-cancel", Description: "Cancel a running swarm", Category: "agents"},
		{Name: "/classify", Description: "Classify a message signal", Category: "intelligence"},
		{Name: "/diff", Description: "Show diff for a file", Category: "context"},
		{Name: "/attach", Description: "Attach a file to the message", Category: "context"},
		{Name: "/login", Description: "Authenticate with token", Category: "auth"},
		{Name: "/logout", Description: "Log out", Category: "auth"},
		{Name: "/thinking", Description: "Toggle thinking display", Category: "config"},
		{Name: "/export", Description: "Export conversation", Category: "system"},
